...
-- Mon 10 Aug 2020 03:35:11 PM +04
...
CREATE TABLE IF NOT EXISTS `coco-projet`.`animals` (
  ...
  CONSTRAINT `fk_animal_veterinary1_idx`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_animals_health_records1_idx`
...
-- -----------------------------------------------------
-- Table `coco-projet`.`treatment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `coco-projet`.`treatment` ;

CREATE TABLE IF NOT EXISTS `coco-projet`.`treatment` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `rappel` DATETIME NULL DEFAULT NULL,
